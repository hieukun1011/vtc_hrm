...
class AttendanceDeviceUser(models.Model):
    ...
    del_user = fields.Boolean(string='Delete User', default=False, tracking=True, help='If checked, the user on the device will be deleted upon deleting this record in Odoo')
