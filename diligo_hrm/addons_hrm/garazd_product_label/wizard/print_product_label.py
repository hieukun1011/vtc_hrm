...
class PrintProductLabel(models.TransientModel):
    ...
    def _get_products(self):
        res = []
        if self._context.get('active_model') == 'sci.device.main':
    ...
    template = fields.Selection(
        selection=[('garazd_product_label.report_product_label_A4_57x35', '1 tem 57x35mm (A4: 21 pcs on sheet, 3x7)'),
                   ('garazd_product_label.report_product_label_A5_77x25', '2 tem 77x25mm')],
        string='Mẫu giấy in',
