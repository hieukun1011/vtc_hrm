...
class ApprovalCategory(models.Model):
    ...
    has_time_need = fields.Selection(CATEGORY_SELECTION, string="Time need", default="no", required=True)
    has_proposed_date = fields.Selection(CATEGORY_SELECTION, string="has proposed date", default="no", required=True)
    has_intended_use = fields.Selection(CATEGORY_SELECTION, string="Has intended use", default="no", required=True)
    has_resource = fields.Selection(CATEGORY_SELECTION, string="Has Resource", default="no", required=True)
    has_vehicle = fields.Selection(CATEGORY_SELECTION, string="Has Vehicle", default="no", required=True)
    ...
    has_job = fields.Selection(CATEGORY_SELECTION, string="Job", default="no", required=True)
    ...
    has_date_start = fields.Selection(CATEGORY_SELECTION, string="date start", default="no", required=True)
    has_monday = fields.Selection(CATEGORY_SELECTION, string="monday", default="no", required=True)
