                ...
                return (
                  ...
                  1 == e
                    ? ((o.style.cssText =
                      ...
                      (a = 1))
                    : ((o.style.cssText = t + "position:relative; padding-top:3rem; transform: scale(1.5)"),
                      e.firstChild
...
var simplemaps_countrymap_mapinfo = {
  ...
  default_labels: {},
  proj_coordinates: [
    { lat: 10.416667, x: 543.6, lng: 106.116667, y: 1842.8 },
    { lat: 10.183333, x: 468.9, lng: 105.566667, y: 1875 },
    { lat: 10.266667, x: 471.2, lng: 105.583333, y: 1863.5 },
  ],
  initial_view: {
    x2: 1458.0855000000001,
    x: -448.1055000000001,
    y2: 2118.98,
    y: 0.99,
  },
...
!(function (e) {
  ...
  (function () {
    ...
    function v(e) {
      for (
        var t = e.match(n), o = t.length, i = e.match(r)[0], a = 0;
        a < o;
        a++
      )
        i += parseInt(t[a], 10) + ",";
    ...
    function yo() {
      if (r)
        if (location.hostname.match("simplemaps.com")) r = !1;
          ...
          var e = s || l ? "20px" : "5px";
          (Lt.style.cssText =
            "overflow: visible !important; clip-path: none !important; display:inline !important; opacity:0 !important; transform: none !important; visibility: visible !important; z-index: 1 !important; right: 5px !important; bottom:" +
            e +
            ...
            ne || (503 != Lt.innerHTML.length && (_e.innerHTML = ""));
        }
    }
    function go() {
      var t,
        ...
        if (st.hasOwnProperty(e)) {
          ...
          if (
            ("state" == t.parent_type
              ...
              ? (m = vt[t.parent_id])
              : "location" == t.parent_type && (m = zt[t.parent_id]),
            !t.x && !t.y && m)
          )
      ...
      (Bt = function () {
        ...
        (Ot = function (e, t) {
          if (
            ...
            !Ht && !mo && ((Kt = !1), this.id || "set" != !this.type))
          ) {
            var o = Vo(this);
            if (o && !o.sm.inactive)
            ...
            (function () {
              function e(e) {
                var o = Zo(e),
                  ...
                  c = 5 * t.r;
                return (
                  (Math.abs(s) > c || Math.abs(l) > c) && (qt = !0),
                  { x: t.x + s, y: t.y + l, w: t.w, h: t.h, r: t.r }
                );
              }
              var t,
                i,
    ...
    function oi(t) {
      ...
      (function () {
        ...
        (c = "no" != _.back_image_url && _.back_image_url),
          ...
          (p =
            u ||
            t.substring(0, t.lastIndexOf("/namap.js") + 1) + "map_images/"),
          !c && o && (c = p + o);
      })(),
      (ie = "VML" == Raphael.type),
