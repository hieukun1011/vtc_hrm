...
class Home(http.Controller):
    ...
    # override
    @http.route('/web/login', type='http', auth="none", csrf=False, cors="*")
    def web_login(self, redirect=None, **kw):
        ...
        if style == 'default' or style is False:
            ...
            response = request.render('fims_login_background_and_styles.left_login_template', values)
        elif style == 'right':
            response = request.render('fims_login_background_and_styles.right_login_template', values)
        else:
            response = request.render('fims_login_background_and_styles.middle_login_template', values)
